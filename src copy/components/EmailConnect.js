...
export function EmailConnect({ onSubmit, btnText, loading=true }) {
  ...
  return (
    ...
    >
      <TextField
        ...
        fullWidth
        InputProps={{
          endAdornment: <IconButton onClick={cancelMail}>
            <CancelSearch />
          </IconButton>
        }}
      />
      <TextField
        ...
        InputProps={{
          endAdornment: <IconButton onClick={passVisibleControls.toggle}>
